...
<body>
    ...
    <div class="container bg-light rounded">
            <h2>Selamat bekerja <?=$_SESSION['nama_petugas']?></h2>
            <p>Ini adalah paragraf singkat yang menjelaskan tentang TOKO OREN. Kami menyediakan berbagai macam produk berkualitas tinggi.</p>
    </div>
</body>
</html>